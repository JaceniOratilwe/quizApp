...
@Component({
  selector: 'app-tot-science',
  templateUrl: './tot-science.page.html',
  styleUrls: ['./tot-science.page.scss'],
})
export class TotSciencePage implements OnInit {
  correct: number;
  correct1: number;
  correct2: number;
  correct3: number;
    ...
    .subscribe(params =>
 {
  ...
  GoTo4(){
    ...
    this.router.navigate(['/tot-science'], { queryParams: {correct:this.correct, correct1:this.correct1,correct2:this.correct2,correct3:this.correct3,correct4:this.correct4,final:this.final} });
  }
  click1(){
    if(this.correct4  += 0){
  ...
  GoToN()
  {
    this.router.navigateByUrl("correct-s");
  }
